...
centrar_texto('Argentine resident in Brazil since 2016, I am a family man with a Brazilian wife, Samella, and two children,', 7, 'white')
centrar_texto('Benício Luca and Ester Valentina. Professionally I have diverse experiences, mainly in tourism as a', 7, 'white')
centrar_texto('micro-entrepreneur and running Lupita Hostel e Pousada in Maceió. Later I ventured into making and selling', 7, 'white')
centrar_texto('alfajores during and after the pandemic, displayed at @alfajor.milagros on Instagram.', 7, 'white')
st.title("#")
centrar_texto('My previous career in Argentina involved sales at Unifon, including managing their sales team,', 7, 'white') 
centrar_texto('and then at Parmalat as a supervisor. I joined Nokia in 2006 and worked as a field supervisor,', 7, 'white') 
centrar_texto('supervising a team, organizing events and participating in sales and commercial management.', 7, 'white')
st.title("#")
centrar_texto('Throughout my career, I have consistently worked with metrics, data, and statistical analysis,', 7, 'white') 
centrar_texto('primarily using Excel. My interest in data analysis led me to explore tools beyond Excel, such as SQL,', 7, 'white') 
centrar_texto('Python, and Power BI. I am a Python programmer, I enrolled in the Google Data Analytics PT by Coursera', 7, 'white') 
centrar_texto('course to further structure my studies. My innate curiosity and dedication drive me to continually learn', 7, 'white') 
centrar_texto('and hone my skills in the ever-evolving field of data analytics.', 7, 'white')
