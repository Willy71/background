...
centrar_texto('Argentine resident in Brazil since 2016, I am a family man with a Brazilian wife, Samella, and two children, 
                Benício Luca and Ester Valentina. Professionally I have diverse experiences, mainly in tourism as a
                micro-entrepreneur and running Lupita Hostel e Pousada in Maceió. Later I ventured into making and selling
                alfajores during and after the pandemic, displayed at @alfajor.milagros on Instagram.', 6, 'white')
st.title("#")
...
st.title("")
st.title("")
centrar_texto('Cristina Jacquemin - Accounts director - Grupo Solvens', 4, 'lightblue')
st.caption("")
...
st.title("")
st.title("")
centrar_texto("Ariel Smirnoff - Business coach", 4, 'lightblue')
st.caption("")
