...
with st.container():
    ...
    with col1:
        centrar_imagen_link("https://github.com/Willy71/background/blob/main/picture/Coursera.png?raw=true", "https://chicagobike.streamlit.app/", "Coursera Case Study", 210)
