...
with col31:
    centrar_texto(f'I am an Argentine resident in Brazil since 2016 with diverse professional experiences, mainly in tourism as a micro-entrepreneur running Lupita Hostel e Pousada in Maceió. During and after the pandemic, I also made and sold alfajores, showcased on Instagram at @alfajor.milagros. My career in Argentina included sales roles at Unifon, managing their sales team, and at Parmalat as a supervisor. I joined Nokia in 2006 as a field supervisor, organizing events and participating in sales and commercial management. Throughout my career, I have consistently worked with metrics, data, and statistical analysis, primarily using Excel. My interest in data analysis led me to explore tools like SQL, Python, and Power BI. I am a Python programmer and enrolled in the Google Data Analytics PT course on Coursera to further structure my studies. My curiosity and dedication drive me to continually learn and hone my skills in data analytics.', 6, 'white')
    st.title("#")
